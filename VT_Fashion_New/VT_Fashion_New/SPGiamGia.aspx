<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="SPGiamGia.aspx.cs" Inherits="VT_Fashion_New.SPGiamGia" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:DataList ID="DataList1" Class="dtlsp1" runat="server" RepeatColumns="3">
        <ItemTemplate>
            <div class="box">
                <div class="hover">
                    <asp:LinkButton ID="LinkButton2" runat="server" class="fas fa-cart-plus heart" CommandArgument='<%# Eval("masp") %>' OnClick="btnThem_Click"></asp:LinkButton>
                ...
                <div class="info">
                    <div class="name">
                        ...
                        <strong class="price">
                            <asp:Label ID="Label3" runat="server" Text='<%# Eval("giagiam", "{0:0,0}") %>'></asp:Label>
                            <asp:Label ID="Label5" runat="server" Text="<big>đ </big>"></asp:Label>
                            <span class="gg">
                                <asp:Label ID="Label4" runat="server" Text='<%# Eval("giaban", "{0:0,0}")+"<big>đ </big> " %>'></asp:Label>
                            </span>
                        </strong>
                    </div>
                </div>
